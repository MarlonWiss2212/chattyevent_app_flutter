...
import 'package:chattyevent_app_flutter/infrastructure/models/event/event_left_user_model.dart';
import 'package:chattyevent_app_flutter/infrastructure/models/event/event_model.dart';
import 'package:chattyevent_app_flutter/infrastructure/models/event/event_user_model.dart';
import 'package:chattyevent_app_flutter/infrastructure/models/request/request_model.dart';
...
import 'package:chattyevent_app_flutter/infrastructure/filter/event/event_left_user/find_event_left_users_filter.dart';
import 'package:chattyevent_app_flutter/infrastructure/filter/event/event_user/find_one_event_user_filter.dart';
import 'package:chattyevent_app_flutter/infrastructure/filter/event/event_user/find_event_users_filter.dart';
      ...
      final response = await graphQlDatasource.mutation(
        """
          mutation UpdateEventUser(\$input: UpdateEventUserInput!, \$filter: FindOneEventUserInput!) {
            updateEventUser(updateEventUserInput: \$input, filter: \$filter) {
              eventUserId
              username
              _id
              authId
