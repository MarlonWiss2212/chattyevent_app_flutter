...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> de = {
    "general": {
      ...
      "messageArea": {"noMessagesText": "Keine Nachrichten"},
      "groupchatPermissionMenu": {"onlyAdminsText": "Nur Admins"},
      "request": {
        "invitationEventText":
            "Der Benutzer {} hat Ihnen eine Einladung zum Event {} für das folgende Datum gesendet: {}",
        "invitationGroupchatText":
            "Der Benutzer {} hat Ihnen eine Einladung zum Gruppenchat {} gesendet"
      },
      "eventPermissionMenu": {
      ...
      "chatMessageInput": {
        "textField": {"hintText": "Nachricht"},
        "voiceMessage": {"title": "Sprachnachricht"}
      },
      "dialog": {
        "cameraText": "Kamera",
        "galleryText": "Galerie",
    ...
    "authPages": {
      "dataprotectionBox": {
        "text1": "Ich habe die ",
        "text2": " und die ",
        "text3": " gelesen und stimme ihnen zu",
    ...
    "homePage": {
      "pages": {
        "chatPage": {"title": "Chats", "noChatsText": "Keine Chats"},
        "eventPage": {
          "title": "Events",
        ...
        "mapPage": {"title": "Event Map"},
        "searchPage": {"title": "Entdecken"},
    ...
    "eventPage": {
      "tabs": {
        "shoppingListTab": {"title": "Einkaufsliste"},
        "userListTab": {
          "title": "Mitglieder",
          "leftUserList": {"pastMembers": "Vergangene Mitglieder: {}"},
          "userList": {
            "addUserToEvent": "Benutzer zum Event hinzufügen",
            "membersThatWillBeThereCount":
                "Mitglieder, die dabei sein werden: {}",
          ...
          "invitationList": {
            "errorToDisplayOneInvitationText":
                "Fehler beim Anzeigen eines eingeladenen Benutzers",
          ...
          "leaveEventButton": {
            ...
            "leaveEventDescriptionText":
                "Möchten Sie das Event wirklich verlassen?"
          }
        },
        "infoTab": {
          ...
          "coverImageButton": {
            "saveCoverImageDescription":
                "Möchten Sie das Bild als Titelbild für das Event verwenden?",
            "deleteCoverImageDescription":
                "Möchten Sie das Titelbild des Event wirklich löschen?"
          },
          "statusButton": {
            "leftText": "Status: ",
      ...
      "createShoppingListItemPage": {
        "title": "Neuer Artikel",
        "fields": {
          "itemNameField": {"lable": "Artikelname"},
          "amountField": {"lable": "Menge"},
          "unitField": {"lable": "Einheit"}
        },
        "userWhoShouldBuyTheItemText":
            "Benutzer, der den Artikel kaufen soll: {}"
      },
      "inviteUserPage": {"title": "Benutzer zum Event hinzufügen"},
      "updateLocationPage": {"title": "Standort aktualisieren"},
      "updatePermissionPage": {
        "title": "Mitgliederberechtigungen aktualisieren"
      }
    },
    "groupchatPage": {
      "addUserPage": {"title": "Benutzer zum Gruppenchat hinzufügen"},
      "infoPage": {
        "invitationList": {
          "errorToDisplayOneInvitationText":
              "Fehler beim Anzeigen eines eingeladenen Benutzers",
        ...
        "leaveChatButton": {
          ...
          "leaveGroupchatDescriptionText":
              "Möchten Sie den Gruppenchat wirklich verlassen?"
        },
        "profileImageButton": {
          "saveProfileImageDescription":
              "Möchten Sie das Bild als Profilbild für den Gruppenchat verwenden?",
          "deleteProfileImageDescription":
              "Möchten Sie das Profilbild des Gruppenchats wirklich löschen?"
        },
      ...
      "futurePrivateEventsPage": {
        ...
        "noFuturePrivateEventsText":
            "Keine künftigen privaten Events für diesen Gruppenchat"
      },
      "updatePermissionPage": {"title": "Mitgliederberechtigungen"}
    },
    "introductionPages": {
      "permissionPages": {
        "general": {
        ...
        "microphonePage": {
          "text":
              "Wenn Sie das Mikrofon beispielsweise für Sprachnachrichten verwenden möchten, drücken Sie bitte auf Anfordern."
        },
        "notificationPage": {
          "text":
              "Wenn Sie Benachrichtigungen wie Nachrichten, Einladungen usw. erhalten möchten, drücken Sie bitte auf Anfordern."
        }
      },
      "featurePages": {
        "messagePage": {
    ...
    "newGroupchatPage": {
      ...
      "pages": {
        "permissionTab": {"title": "Mitgliederberechtigungen"},
        "selectUserTab": {"title": "Mitglieder auswählen"}
      },
      "fields": {
        "nameField": {"lable": "Name*"},
        "descriptionField": {"lable": "Beschreibung (optional)"},
      ...
      "pages": {
        ...
        "eventTypTab": {
          "privateGroupchatEvent": {
            ...
            "description":
                "Hier verknüpfen Sie ein Event mit einem Gruppenchat. Alle Benutzer, die sich im Gruppenchat befinden, werden automatisch eingeladen. Wenn ein Benutzer den Chat verlässt oder entfernt wird, geschieht dies auch im Event."
          },
          "normalPrivateEvent": {
            "title": "Normales privates event",
            "description":
                "Hier können Sie Benutzer unabhängig von einem Chat einladen oder ausladen."
          }
        }
      },
      "fields": {
    ...
    "profilePage": {
      "profileImageButton": {
        "saveProfileImageDescription":
            "Möchten Sie das Bild als Profilbild verwenden?",
      ...
      "userRelationsTabs": {
        ...
        "followedTab": {"title": "Gefolgt", "noFollowedText": "Keine Gefolgt"},
        "followerTab": {
          "title": "Follower",
      ...
      "chatPage": {
        "otherUserNotFollowerInfoText":
            "Der andere Benutzer kann Ihnen keine Nachricht schreiben, da er Ihnen nicht folgt. Wenn Sie mit ihm schreiben möchten, überprüfen Sie bitte, ob er Ihnen eine Freundschaftsanfrage gesendet hat. Der andere Benutzer kann jedoch Ihre Nachrichten lesen."
      }
    },
    "settingsPage": {
      "title": "Einstellungen",
      ...
      "privacyPage": {
        ...
        "howOthersInteractWithYouText":
            "Wie dürfen andere mit Ihnen interagieren?",
        "calenderTileMessage":
            "Follower können sehen, ob Sie Zeit an einem Termin haben",
        "updatePasswordPage": {
          "title": "Passwort aktualisieren",
          "newPasswordText": "Neues Passwort",
          "confirmNewPasswordText": "Neues Passwort bestätigen",
          "sendEmailText":
              "Kann nicht erneut überprüfen? E-Mail zum Zurücksetzen des Passworts senden"
        },
        "updateEmailPage": {
        ...
        "updateBirthdatePage": {"title": "Geburtsdatum aktualisieren"},
        "chipTitles": {
          "noone": "Niemand",
        ...
        "userListTexts": {
          ...
          "couldntLoadUsersDueToPermission":
              "Benutzer können aufgrund fehlender Berechtigungen nicht geladen werden"
        },
      ...
      "infoPage": {
        ...
        "rightOnDeletionPage": {
          ...
          "text":
              "Wenn Sie auf die Schaltfläche 'Daten löschen' klicken, werden alle Ihre Daten gelöscht.",
          "followingDataWillBeDeletedText":
              "Die folgenden Daten können nicht gelöscht werden:",
  ...
  static const Map<String, dynamic> en = {
    "general": {
      ...
      "messageArea": {"noMessagesText": "No messages"},
      "groupchatPermissionMenu": {"onlyAdminsText": "Only Admins"},
      "request": {
        "invitationEventText":
            "The user {} send you and invitation to the event {} at the following date: {}",
        "invitationGroupchatText":
            "The user {} send you and invitation to the groupchat {}"
      },
      "eventPermissionMenu": {
    ...
    "homePage": {
      "pages": {
        "chatPage": {"title": "Chats", "noChatsText": "No chats"},
        "eventPage": {
          "title": "Events",
    ...
    "eventPage": {
      "tabs": {
        "shoppingListTab": {"title": "Shopping List"},
        "userListTab": {
          "title": "Members",
          "leftUserList": {"pastMembers": "Past members: {}"},
          "userList": {
          ...
          "invitationList": {
            "errorToDisplayOneInvitationText":
                "Error when displaying an Invited User",
          ...
          "leaveEventButton": {
            ...
            "leaveEventDescriptionText":
                "Do you really want to leave the event?"
          }
        },
        "infoTab": {
          ...
          "coverImageButton": {
            "saveCoverImageDescription":
                "Do you want to take the image as the event cover image?",
            "deleteCoverImageDescription":
                "Do you want to delete the event cover image?"
          },
          "statusButton": {
            "leftText": "Status: ",
      ...
      "createShoppingListItemPage": {
        "title": "New Item",
        "fields": {
          "itemNameField": {"lable": "Item name"},
          "amountField": {"lable": "amount"},
          "unitField": {"lable": "unit"}
        },
        "userWhoShouldBuyTheItemText": "User that should buy the item: {}"
      },
      "inviteUserPage": {"title": "Add User to Event"},
      "updateLocationPage": {"title": "Update location"},
      "updatePermissionPage": {"title": "Member permissions"}
    },
    "groupchatPage": {
      "addUserPage": {"title": "Add user to Groupchat"},
      "infoPage": {
        "invitationList": {
          "errorToDisplayOneInvitationText":
              "Error when displaying an Invited User",
        ...
        "leaveChatButton": {
          ...
          "leaveGroupchatDescriptionText":
              "Do you really want to leave the group chat?"
        },
        "profileImageButton": {
          "saveProfileImageDescription":
              "Do you want to take the image as groupchat profile image?",
          "deleteProfileImageDescription":
              "Do you want to delete the groupchat profile image?"
        },
      ...
      "futurePrivateEventsPage": {
        ...
        "noFuturePrivateEventsText":
            "No future private events for this groupchat"
      },
      "updatePermissionPage": {"title": "Member permissions"}
    },
    "introductionPages": {
      "permissionPages": {
        ...
        "microphonePage": {
          "text":
              "If you want to use the microphone for e.g. voice messages. Please press request"
        },
        "notificationPage": {
          "text":
              "If you want to receive notifications such as messages, you have been invited, etc.. Please press request"
        }
      },
      "featurePages": {
        "messagePage": {
    ...
    "newGroupchatPage": {
      "title": "New groupchat",
      "pages": {
        "permissionTab": {"title": "Member Permissions"},
        "selectUserTab": {"title": "Select Members"}
      },
      "fields": {
        "nameField": {"lable": "Name*"},
        "descriptionField": {"lable": "Description (optional)"},
        "deleteAfterEndDateSwitch": {
    ...
    "newPrivateEventPage": {
      ...
      "pages": {
        ...
        "locationTab": {"title": "Location (optional)"},
        "permissionTab": {"title": "Member Permissions"},
        "selectUserTab": {"title": "Select Members"},
        "eventTypTab": {
          "privateGroupchatEvent": {
            ...
            "description":
                "Here you connect an event with a group chat. All users who are in the group chat are automatically invited. If a user leaves the chat or is kicked, this also happens in the event."
          },
          "normalPrivateEvent": {
            "title": "Normal private event",
            "description":
                "You can invite and uninvite users here independently from a chat"
          }
        }
      },
      "fields": {
    ...
    "profilePage": {
      "profileImageButton": {
        "saveProfileImageDescription":
            "Do you want to take the image as profile image?",
        "deleteProfileImageDescription":
            "Do you want to delete the profile image?"
      },
      "userRelationsTabs": {
        "followRequestsTab": {
        ...
        "followedTab": {"title": "Followed", "noFollowedText": "No followed"},
        "followerTab": {"title": "Followers", "noFollowersText": "No followers"}
      },
      "chatPage": {
        "otherUserNotFollowerInfoText":
            "The other user can't write you a message because he doesn't follow you, if you want to write with him, please check if he sent you a friend request. But the other user can read your message"
      }
    },
    "settingsPage": {
      "title": "Settings",
      ...
      "privacyPage": {
        ...
        "calenderTileMessage":
            "Followers can see if you have time on an appointment",
        "updatePasswordPage": {
        ...
        "updateBirthdatePage": {"title": "Update Birthdate"},
        "chipTitles": {
          "noone": "Noone",
        ...
        "userListTexts": {
          ...
          "couldntLoadUsersDueToPermission":
              "Kann keine User laden, da die berechtigung nicht geladen werden konnte"
        },
        "privateEventAddMePage": {"title": "Private event add permission"},
        "groupchatAddMePage": {"title": "Groupchat add permission"},
        "calendarWatchIHaveTimePage": {"title": "Calendar see permission"}
      },
      "infoPage": {
        "title": "Info & Privacy",
        "faqText": "FAQ",
        ...
        "rightOnDeletionPage": {
          ...
          "text":
              "When you click on the 'Delete data' button all your data will be deleted.",
          "followingDataWillBeDeletedText":
    ...
    "createUserPage": {"title": "Create User", "usernameLable": "Username"},
    "loginPage": {
      "title": "Login",
      "emailLable": "E-Mail",
