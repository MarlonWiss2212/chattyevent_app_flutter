      ...
      builder: (context, state) {
        return PlatformScaffold(
          ...
          body:
            ...
            child: Column(
              children: [
                BlocBuilder<AddShoppingListItemCubit, AddShoppingListItemState>(
                  builder: (context, state) {
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      "User der das Item kauft: ${privateEventUser != null ? privateEventUser!.id : ''}",
                                ...
                                SelectUserCreateShoppingListItem(
                                  newUserSelected: (newprivateEventUser) {
                                    setState(() {
                                      privateEventUser = newprivateEventUser;
                                    });
                                  },
                                ),
                              ],
