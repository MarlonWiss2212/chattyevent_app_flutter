...
class PrivateEventTabInfoStatus extends StatelessWidget {
  ...
  Widget textWidget(BuildContext context, CurrentPrivateEventState state) => Text(
                ...
                state.privateEvent.status == null && state.loadingPrivateEvent
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          if(state.currentUserAllowedWithPermission(permissionCheckValue: state.privateEvent.permissions?.changeStatus)) ...{
                            PopupMenuButton(
                              initialValue: state.privateEvent.status,
                              onSelected:(value) => BlocProvider.of<CurrentPrivateEventCubit>(context)
