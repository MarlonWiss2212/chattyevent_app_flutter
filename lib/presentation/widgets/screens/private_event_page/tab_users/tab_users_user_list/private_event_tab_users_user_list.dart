...
import 'package:chattyevent_app_flutter/presentation/widgets/screens/private_event_page/tab_users/tab_users_user_list/private_event_tab_users_user_list_item.dart';
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return PrivateEventTabUsersUserListItem(
                    ...
                    privateEventUser: state.eventUsers[index],
                    event: state.event,
                  );
                },
