...
class AppRouter extends _i61.RootStackRouter {
  ...
  final Map<String, _i61.PageFactory> pagesMap = {
    ...
    PastEventsPageRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i15.PastEventsPage(),
      );
    },
    ShoppingListWrapperPageRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i16.ShoppingListWrapperPage(),
      );
    },
    ...
    PrivateEventWrapperPageRoute.name: (routeData) {
      ...
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: _i18.PrivateEventWrapperPage(
    ...
    NewGroupchatWrapperPageRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i20.NewGroupchatWrapperPage(),
      );
    },
    ...
    ProfileFollowerUserSettingsPageRoute.name: (routeData) {
      ...
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: _i28.ProfileFollowerUserSettingsPage(
          key: args.key,
    ...
    ProfileUserSettingsPageRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i52.ProfileUserSettingsPage(),
      );
    },
    ...
    NewPrivateEventSearchUserTabRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i57.NewPrivateEventSearchUserTab(),
      );
    },
    NewPrivateEventSearchGroupchatTabRoute.name: (routeData) {
      return _i61.AdaptivePage<dynamic>(
        routeData: routeData,
        child: const _i58.NewPrivateEventSearchGroupchatTab(),
      );
    },
...
/// generated route for
/// [_i28.ProfileFollowerUserSettingsPage]
class ProfileFollowerUserSettingsPageRoute
    extends _i61.PageRouteInfo<ProfileFollowerUserSettingsPageRouteArgs> {
...
/// generated route for
/// [_i57.NewPrivateEventSearchUserTab]
class NewPrivateEventSearchUserTabRoute extends _i61.PageRouteInfo<void> {
...
/// generated route for
/// [_i58.NewPrivateEventSearchGroupchatTab]
class NewPrivateEventSearchGroupchatTabRoute extends _i61.PageRouteInfo<void> {
