...
abstract class $AppRouter extends _i68.RootStackRouter {
  ...
  final Map<String, _i68.PageFactory> pagesMap = {
    ...
    SettingsPrivacyRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i56.SettingsPrivacyPage(),
      );
    },
    GroupchatAddMeRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i57.GroupchatAddMePage(),
      );
    },
    PrivateEventAddMeRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i58.PrivateEventAddMePage(),
      );
    },
    ThemeModeRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i59.ThemeModePage(),
      );
    },
    UpdatePasswordRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i60.UpdatePasswordPage(),
      );
    },
    SettingsRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i61.SettingsPage(),
      );
    },
    ShoppingListItemChangeUserRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i62.ShoppingListItemChangeUserPage(),
      );
    },
    ShoppingListItemRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i63.ShoppingListItemPage(),
      );
    },
    ShoppingListItemWrapperRoute.name: (routeData) {
      ...
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i64.ShoppingListItemWrapperPage(
          key: args.key,
          shoppingListItemId: args.shoppingListItemId,
    ...
    ShoppingListRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i65.ShoppingListPage(),
      );
    },
    ShoppingListWrapperRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i66.ShoppingListWrapperPage(),
      );
    },
    VerifyEmailRoute.name: (routeData) {
      return _i68.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i67.VerifyEmailPage(),
      );
    },
  };
}
...
/// generated route for
/// [_i62.ShoppingListItemChangeUserPage]
...
/// generated route for
/// [_i64.ShoppingListItemWrapperPage]
